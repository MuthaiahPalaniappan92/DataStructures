...
public class RepeatAndMissingNumberArray {
	...
	public static ArrayList<Integer> repeatedNumber(final List<Integer> A) {
		...
		int missingNumber = -1;
		int previousNumber = copyOfA.get(0) - 1;
		for(int i = 0; i < copyOfA.size(); i++)
		{
			int currentValue = copyOfA.get(i);
			if(!repeatedNumberFound || !missingNumberFound)
			{
				...
				{
					if(currentValue != previousNumber + 1)
					{
		...
		if(missingNumber > copyOfA.get(copyOfA.size() - 1) || !missingNumberFound)
		{
			missingNumber = copyOfA.get(0) - 1;
		}
		result.add(missingNumber);
		return result;
    }
	
	private static List<Integer> copyList(List<Integer> A)
	{
		List<Integer> copyOfA = new ArrayList<Integer>();
	...
	private static int pivot(List<Integer> a, int start, int end) 
	{
	...
	private static void swap(List<Integer> a, int i, int pivotIndex) 
	{
		int temp = a.get(i);
